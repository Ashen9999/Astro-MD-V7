...
module.exports = {
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? 'Hi there' : process.env.ALIVE_MSG,
...
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=1mQEAARR#AaxcIRFVwDcAfM7G_ztd7G7A1xuVoDkX1MHeyspiRms' : process.env.SESSION_ID
};
